      ...
      <div className="section-header">
        <div>
          ...
          <p className="section-subtitle">
            Bring Your Own Keys (BYOK) to secure stateless memory extraction and
            RAG queries.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Powers Llama-3 background Knowledge Graph extraction, timeline
              clustering labels, and RAG synthesis.
            </p>
          </div>
          ...
          <div>
            ...
            >
              Generates high-performance 768-dimensional text embeddings stored
              directly inside pgvector.
            </p>
          </div>
