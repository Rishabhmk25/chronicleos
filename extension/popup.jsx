...
export default function Popup() {
  ...
  const [backendUrl, setBackendUrl] = useState(
    "https://chronicalos.onrender.com",
  );
    ...
    >
      ...
      {!token ? (
        <div>
          ...
          {error && (
            <div style={{ color: "#e11d48", fontSize: 12, marginBottom: 10 }}>
              {error}
            </div>
          )}
          <form
          ...
          >
            ...
            <button type="submit" className="btn" style={{ marginTop: 5 }}>
              Authenticate
            </button>
          </form>
        </div>
        ...
        <>
          ...
          >
            ...
            {status === "connected" && (
              ...
              >
                <span style={{ fontSize: 13, color: "rgba(150,180,200,0.5)" }}>
                  Memory Size
                </span>
                <span
                  style={{
          ...
          <a
            href="https://chronicalos.vercel.app/"
            target="_blank"
            rel="noreferrer"
            className="btn"
          >
